...
export function Hero() {
    const { navigateToCreateEvent, navigateToHowItWorks } = useHero();
            ...
            <div className="max-w-6xl w-full">
                <div className="bg-white rounded-3xl shadow-[0_20px_60px_rgba(47,79,79,0.12)] p-12 md:p-16 relative overflow-hidden">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center relative z-10">
                        <div>
                            ...
                            <h1 className="mb-6 text-5xl md:text-6xl font-bold font-serif text-[#2F4F4F]">
                                {t('hero_title')}
                            </h1>
                            ...
                            <div className="flex flex-col sm:flex-row gap-4">
                                ...
                                <button
                                    ...
                                    className="px-8 py-4 bg-transparent text-[#2F4F4F] rounded-xl border-2 border-[#2F4F4F] hover:bg-[#2F4F4F] hover:text-white transition-all"
                                >
                            ...
                            <div className="mt-12 flex items-center gap-8 text-sm text-[#333333]/60">
                                ...
                                <div className="flex items-center gap-2">
                                    <div className="w-2 h-2 bg-[#2F4F4F] rounded-full"></div>
                                    <span>{t('hero_feature_no_registration')}</span>
                                </div>
                                <div className="flex items-center gap-2">
                                    <div className="w-2 h-2 bg-[#2F4F4F] rounded-full"></div>
                                    <span>{t('hero_feature_secure')}</span>
                                </div>
                            </div>
                        </div>
                ...
                <div className="mt-12 grid grid-cols-1 md:grid-cols-3 gap-6">
                    <div className="bg-white rounded-2xl p-8 shadow-md text-center hover:shadow-lg transition-shadow">
                        ...
                        <p className="text-[#333333]/70">{t('hero_stats_events')}</p>
                    </div>
                    <div className="bg-white rounded-2xl p-8 shadow-md text-center hover:shadow-lg transition-shadow">
                        <div className="text-4xl text-[#D24545] mb-2">50,000+</div>
                        <p className="text-[#333333]/70">{t('hero_stats_participants')}</p>
                    </div>
                    <div className="bg-white rounded-2xl p-8 shadow-md text-center hover:shadow-lg transition-shadow">
                        <div className="text-4xl text-[#D24545] mb-2">4.9/5</div>
                        <p className="text-[#333333]/70">{t('hero_stats_rating')}</p>
                    </div>
                </div>
            </div>
        </section>
