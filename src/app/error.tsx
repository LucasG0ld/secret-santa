    ...
    return (
        <div className="min-h-screen flex flex-col items-center justify-center bg-gray-50 px-4 text-center">
            <div className="space-y-6 max-w-md">
                ...
                <h1 className="text-3xl font-bold text-gray-900">Aïe ! Quelque chose s'est cassé.</h1>
                <p className="text-gray-600">
                    Un gremlin a dû se glisser dans le système. Nos lutins ingénieurs sont sur le coup !
                </p>
                <div className="pt-6">
                    <button
                        onClick={reset}
